package com.br.advantage.reports;
...
public class generateHTMLReport {
    ...
    public static void main(String... args){
        ...
        reportBuilder.setReportDirectory(path + "//build//reports//");

        // Set output report file name
        reportBuilder.setReportFileName("CucumberHTML");

        // Set Report Title
        reportBuilder.setReportTitle("Execução de testes Advantage Shop");
        ...
        cucumberJsonReports.add(new File(path + "//build//reports//cucumber.json"));
